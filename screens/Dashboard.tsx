    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="p-6 space-y-4">
                ...
                {activeTab === 'activity' && mockRecentActivity.map((activity, i) => (
                     <div key={i} className="flex gap-4 items-start p-4 rounded-lg bg-gray-50 border border-gray-200/80">
                        <div className="w-10 h-10 rounded-full bg-brand-orange/10 text-brand-orange flex items-center justify-center flex-shrink-0 mt-1">
                            {activity.icon}
                        </div>
                        <div>
