...
// --- Icons ---
// FIX: Updated all icon components to accept standard SVG props, allowing attributes like `className` to be passed.
                    ...
                    {steps.map((step, index) => (
                        <React.Fragment key={step}>
                            <div className="flex flex-col items-center text-center">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 ${index === 0 ? 'bg-[#E87C4D] border-[#E87C4D] text-white' : 'bg-white border-gray-300 text-gray-500'}`}>
                                    {index + 1}
                                </div>
                                <p className={`mt-2 text-sm font-semibold ${index === 0 ? 'text-gray-800' : 'text-gray-500'}`}>{step}</p>
                            </div>
                ...
                <div className="w-full lg:w-2/3 bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-200/80">
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="flex justify-end pt-4">
                            <button type="button" className="bg-[#E87C4D] text-white font-bold py-3 px-8 rounded-lg hover:bg-opacity-90">Next Step &rarr;</button>
                        </div>
                    </form>
                </div>
                ...
                <div className="w-full lg:w-1/3 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200/80 text-center">
                        ...
                        <div className="relative w-32 h-32 mx-auto">
                            <svg className="w-full h-full" viewBox="0 0 36 36">
                                ...
                                <path className="text-[#E87C4D]" strokeWidth="3" strokeDasharray="20, 100" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>
                            </svg>
                            <div className="absolute inset-0 flex items-center justify-center text-3xl font-bold">20%</div>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200/80">
                        ...
                        <ul className="space-y-3">
                            <li><button className="flex items-center gap-3 text-gray-700 hover:text-[#E87C4D] font-semibold"><SparklesIcon /> Generate Deck from Profile</button></li>
