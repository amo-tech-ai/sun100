...
const Privacy: React.FC = () => {
    return (
        <>
            <title>Privacy Policy - Sun AI</title>
            <meta name="description" content="Read the Privacy Policy for the Sun AI Pitch Deck Engine to understand how we handle your data." />
