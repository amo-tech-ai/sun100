...
const SponsorDeckStories: React.FC = () => {
    return (
        <div className="max-w-5xl mx-auto space-y-12">
            <div className="text-center">
                <h1 className="text-4xl font-bold text-gray-800">Sponsor Success Stories</h1>
                <p className="text-lg text-gray-500">Placeholder page for sponsor testimonials.</p>
            </div>
...
export default SponsorDeckStories;
