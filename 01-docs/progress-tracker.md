...
| **8. Full-Stack Migration** | **Authentication Layer** | 0% | 🔴 | **FE:** `Login.tsx`, `Signup.tsx`, `ProtectedRoute.tsx` exist but are wired to a mock/resilient provider.<br/>**BE:** Planned: Supabase Auth or custom JWT.<br/>**AI:** N/A. |
| | **Database & Persistence** | 0% | 🔴 | **FE:** All data persistence is via `sessionStorage` or mock data services.<br/>**BE:** Planned: Cloud SQL or Supabase DB. Schema is fully designed.<br/>**AI:** N/A. |
| | **Secure Backend for AI Calls** | 0% | 🔴 | **FE:** All Gemini calls are currently made client-side from `aiService.ts`.<br/>**BE:** Planned: Move all AI logic to a secure custom backend (Node.js on Cloud Run) or Supabase Edge Functions.<br/>**AI:** N/A. |